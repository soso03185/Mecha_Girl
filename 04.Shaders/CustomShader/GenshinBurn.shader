...
*/
Shader "CustomShader/GenshinBurn"
{
    Properties
    {
        ...
        [Header(Hit Effect)]
        _HitAmount("Hit Amount", float) = 0.5
        _HitColor("Hit Color", Color) = (1,1,1,1)
        _HitDuration("HitDuration Time", float) = 0.3
    ...
    {       
        ...
        {               
            ...
            ZWrite On
           // Blend One Zero
            Blend SrcAlpha OneMinusSrcAlpha //  투명 모드
            ...
            #include "GenshinBurn_Shared.hlsl"
        ...
        Pass
        {
            ...
            #include "BurnShadowCasterPass.hlsl"
            ENDHLSL
