...
// then only overwrite original positionCS.z using imaginary vertex's result positionCS.z m_value
// Will only affect ZTest ZWrite's depth m_value of vertex shader
